...
describe('module: bookingSystem.furnituring', function() {
    ...
    describe('FurnituringCreateCtrl controller', function(){
        ...
        it('should call redirect() after abort() method', inject(function($controller, _Furnituring_) {
            ...
            spyOn(FurnituringCreateCtrl, 'redirectToListPage');

            // Exec method to be tested
            $scope.abort();

            // Check that page was redirected was called
            expect(FurnituringCreateCtrl.redirectToListPage).toHaveBeenCalled();
        }));

        it('should call redirect() and create a FlashMessage after successful Furnituring creation', inject(function($rootScope, $controller, _Furnituring_) {
        ...
        it('should create a FlashMessage after duplicate Furnituring creation', inject(function($rootScope, $controller, _Furnituring_, $q) {
            ...
            expect(FurnituringCreateCtrl.redirectToListPage).not.toHaveBeenCalled();
        }));
