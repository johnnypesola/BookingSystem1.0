...
describe('module: bookingSystem.bookingType', function() {
    ...
    beforeEach(inject(function($controller, _BookingType_, _$location_, $rootScope, _Redirect_) {
        $location = _$location_;
        $scope = $rootScope;

        BookingTypeCreateCtrl = $controller('BookingTypeCreateCtrl', {
            $scope: $scope,
    ...
    describe('BookingTypeCreateCtrl controller', function(){

        it('should call history.back() and create a FlashMessage after successful BookingType creation', inject(function($rootScope, $controller, _BookingType_, Redirect) {
        ...
        it('should create a FlashMessage after duplicate BookingType creation', inject(function($rootScope, $controller, _BookingType_, $q) {
        ...
        it('should create a FlashMessage after unsuccessful BookingType creation', inject(function($rootScope, $controller, _BookingType_, $q) {
